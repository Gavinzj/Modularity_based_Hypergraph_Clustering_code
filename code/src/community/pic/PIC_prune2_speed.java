...
//calculate the running time of PIC algorithm with optimization technique 2
...
public class PIC_prune2_speed {
	...
	public PIC_prune2_speed(int trial, String ordering, double ratio,
...
//		constructADJ_largeGraph(true);	// uncomment this for very large hypergraph
	...
	public void move_split_prune2(int thisNode) {
...
//			deltaQ_short = (incident_weights[clusterIdx] / totalEdgeWeight) + eta_short;
	...
	public void move_split_prune2_largeGraph(int thisNode) {
...
//			System.out.println("split " + split + " largeADJ_nID_length[split] " + largeADJ_nID_length[split]);
	...
	public String pic() throws Exception {
		...
		System.out.println("PIC_prune2_speed " + dataset + " " + lambda + " " + gamma);
		...
		do {
			...
			while (hasIncrease) {
				...
				for (int idx = 0; idx < nodeInOrder.length; idx++) {
					...
					// move
					move_split_prune2(nodeInOrder[idx]);		// uncomment this for normal-sized hypergraph
//					move_split_prune2_largeGraph(nodeInOrder[idx]);	// uncomment this for very large hypergraph
