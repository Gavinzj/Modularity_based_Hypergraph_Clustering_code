...
public class PIC_prune2_speed {
	...
	public PIC_prune2_speed(int trial, boolean toHigherOrder, String ordering, double ratio,
...
//						move_split_prune2_largeGraph(nodeInOrder[idx]);
...
//		System.out.println("ratio " + LouvainHelper.findRatioParallel(toHigherOrder, ordering, moveStrategy, 14));
		...
		for (int trial = 0; trial < trials; trial++) {
			...
			PIC_prune2_speed l = new PIC_prune2_speed(trial, toHigherOrder, ordering,
					ratio, save);
			l.initPart1();
