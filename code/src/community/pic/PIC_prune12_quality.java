...
public class PIC_prune12_quality {
	...
	public PIC_prune12_quality(int trial, boolean toHigherOrder, String ordering, double ratio,
...
//						String str2 = move_split_prune12(nodeInOrder[idx]);
...
//		System.out.println("ratio " + LouvainHelper.findRatioParallel(toHigherOrder, ordering, moveStrategy, 14));
		...
		for (int trial = 0; trial < trials; trial++) {
			...
			PIC_prune12_quality l = new PIC_prune12_quality(trial, toHigherOrder, ordering,
					ratio, save);
			l.initPart1();
