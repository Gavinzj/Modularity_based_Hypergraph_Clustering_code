...
public class PIC_prune12_quality {
	...
	// PIC algorithm with optimization techniques 1 and 2
	public PIC_prune12_quality(int trial, String ordering, double ratio,
	...
	public String move_split_prune12(int thisNode) {
	...
	public String pic() throws Exception {
		...
		System.out.println("PIC_prune12_quality " + dataset + " " + lambda + " " + gamma);
