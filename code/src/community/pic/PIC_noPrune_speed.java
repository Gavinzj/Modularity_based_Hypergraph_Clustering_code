...
public class PIC_noPrune_speed {
	...
	public PIC_noPrune_speed(int trial, boolean toHigherOrder, String ordering, double ratio,
...
//						move_split_largeGraph(nodeInOrder[idx]);
...
//		System.out.println("ratio " + LouvainHelper.findRatioParallel(toHigherOrder, ordering, moveStrategy, 14));
		...
		for (int trial = 0; trial < trials; trial++) {
			...
			PIC_noPrune_speed l = new PIC_noPrune_speed(trial, toHigherOrder, ordering,
					ratio, save);
			l.initPart1();
